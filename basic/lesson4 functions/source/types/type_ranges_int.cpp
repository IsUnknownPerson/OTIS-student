...
/*
             short          size is 2 byte(s)      min value =      -32768      max value =       32767
    unsigned short          size is 2 byte(s)      min value =           0      max value =       65535

               int          size is 4 byte(s)      min value = -2147483648      max value =  2147483647
      unsigned int          size is 4 byte(s)      min value =           0      max value =  4294967295

              long          size is 4 byte(s)      min value = -2147483648      max value =  2147483647
     unsigned long          size is 4 byte(s)      min value =           0      max value =  4294967295

         long long          size is 8 byte(s)      min value =   -9223372036854775808      max value =    9223372036854775807
unsigned long long          size is 8 byte(s)      min value =                      0      max value =   18446744073709551615

       std::size_t          size is 8 byte(s)      min value =                      0      max value =   18446744073709551615
*/
